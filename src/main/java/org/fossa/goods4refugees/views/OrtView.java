...
public class OrtView extends View {
    ...
    public enum Template{
    	MUSTACHE("mustache/ort.mustache");
    ...
    public OrtView(OrtView.Template template, ImmutableMap<String,String> environmentConfig, String ortname, List<Hilfsgut> hilfsgueter, List<Abgabestelle> abgabestellen) {
