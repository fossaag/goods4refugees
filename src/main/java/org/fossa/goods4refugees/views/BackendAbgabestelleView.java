...
public class BackendAbgabestelleView extends View {
	
	private final ImmutableMap<String,String> environmentConfig;
	private final List<Hilfsgut> meineHilfsgueter;
	private final BackendUser backendUser;
    
    public enum Template{
    	MUSTACHE("mustache/backendAbgabestelle.mustache");
    ...
    public BackendAbgabestelleView(BackendAbgabestelleView.Template template, ImmutableMap<String,String> environmentConfig, List<Hilfsgut> meineHilfsgueter, BackendUser backendUser) {
        super(template.getTemplateName(), Charsets.UTF_8);
        this.environmentConfig = environmentConfig;
        this.meineHilfsgueter = meineHilfsgueter;
        this.backendUser = backendUser;
    }
    
	public List<Hilfsgut> getMeineHilfsgueter() {
		return meineHilfsgueter;
	}
