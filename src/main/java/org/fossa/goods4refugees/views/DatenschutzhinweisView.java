...
public class DatenschutzhinweisView extends View {
	
	private final ImmutableMap<String,String> environmentConfig;
    
    public enum Template{
    	MUSTACHE("mustache/datenschutzhinweis.mustache");
    ...
    public DatenschutzhinweisView(DatenschutzhinweisView.Template template, ImmutableMap<String,String> environmentConfig) {
