...
public class DankeView extends View {
	
	private final ImmutableMap<String,String> environmentConfig;
    
    public enum Template{
    	MUSTACHE("mustache/danke.mustache");
    ...
    public DankeView(DankeView.Template template, ImmutableMap<String,String> environmentConfig) {
